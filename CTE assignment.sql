...
-- by removing the partial dependencies between payment attributes. Now, the payment table confirms to 2NF.

/*
--Q5 Write a query using cte to retrieve the distinct list of actor names and number of films they have acted in from the actor and film_actor table
*/
...
/*
--Use recursive cte to generate a hierachical list of catagories and their subcatagories from the catagory table
*/
